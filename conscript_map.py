...
def benefit_rows(profile: dict | None = None,
    ...
    rows.append({
        ...
        "how": [
            ...
            "המדרג תלוי בתעודת לוחם ולא במסלול השירות — לכן מוצגות כאן כל האפשרויות.",
        ],
    ...
    rows.append({
        ...
        "how": [
            ...
            "ומתעדכן לפי המדד.",
            "לכן לא מוצג כאן סכום בשקלים.",
        ],
        "cite": _ent.cite(_D_SUBSIST, "סעיף 1"),
        "ask": "ממה מורכבים דמי הקיום שאני מקבל?",
    })

    food_sub = "כשאין הסדר הזנה, בתפקיד מחוץ ליחידה, או לחייל בודד"
    rows.append({
        "section": "now",
        "title": "דמי כלכלה",
    ...
    rows.append({
        ...
        "how": [
            ...
            "בסכום.",
            "הדיווח לשליש היחידה בצירוף תעודה, והיחידה מדווחת על השינוי בטופס 19.",
        ],
    ...
    rows.append({
        ...
        "how": [
            ...
            "הילדים הקטינים.",
            "השכר הבסיסי הוא 50% מהשכר הממוצע במשק, וסך כל התשלומים לא יעלה על 120% ממנו.",
    ...
    grant_how = [
        ...
        "המענק פטור ממס. מקורו בחוק אזרחי ולא בפקודת צבא.",
    ]
    if est:
    ...
    rows.append({
        ...
        "cite": f"לפי {_D_ABSORB}",
        "asof": RATES_ASOF,
        "ask": "לאילו מטרות מותר לי להשתמש בפיקדון האישי?",
    })

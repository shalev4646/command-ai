...
_APPEAL = {
    ...
    "lines": [
        ...
        "הערעור נדון בוועדת ערר שהרמטכ\"ל ממנה.",
        ...
        "steps": [
            {
                ...
                "lines": [
                    "הוועדה דנה בשמ\"פ של שישה ימים ומעלה (על שמ\"פ קצר יותר — מול היחידה).",
        ...
        "steps": [
            ...
            },
            {
                ...
                "lines": [
                    ...
                    "בשעת חירום מוכרזת: פונים לוועדה לתיאום שירות מילואים אישי (ולת\"ם פרט) "
                    "דרך אתר המילואים.",
                ],

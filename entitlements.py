...
LEAVE_CATEGORIES: dict[str, dict] = {
    "release": {
        "title": "חופשת שחרור",
        "pick_label": "רמת פעילות (רמ\"פ) / תעודת לוחם",
        "cases": [
            {
        ...
        "cases": [
            {
                ...
                "note": "זו המכסה הכוללת שממנה נגזרות העילות הפרטניות שברשימה.",
            },
            {
                "label": "נישואין",
                "days": "10 ימים",
        ...
        "cases": [
            {
                ...
                "note": "חלה על חופשה מיוחדת כלכלית / סוציאלית / טעמים אישיים אחרים "
                        "ועל למידה לבחינות. תוספת של עד 15 ימים באישור מפקד יחידה/סא\"ל.",
            },
            {
                "label": "למידה לבחינה",
...
FAMILY_BASE_NOTE = (
    ...
    "(פרק א׳, הגדרת \"שכר בסיסי\"), ומתעדכן לפי פיצוי ההתייקרות. הפקודה אינה נוקבת "
    "בסכום בשקלים."
)

...
DEFAULT_PATH = _path(
    ...
    'נציב קבילות החיילים הוא בדרך כלל הכתובת האחרונה — אחרי שהפנייה בתוך היחידה לא פתרה את הבעיה.',
)
...
PATHS: dict[str, dict] = {
    ...
    '2.0101': _path(
        ...
        'לפי הפקודה; מי שאינו נושא את נשקו בחופשה מפקיד אותו בנשקיית היחידה.',
    ),

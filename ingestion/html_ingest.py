...
CATALOG = {
    ...
    # ה-ids ההיסטוריים (PM-33.0207...) נשמרים — כל הקוד/eval מפנים אליהם.
    # חריג: "05.104" היה מספר שבור מפרסור ישן; תוקן ל-35.0408 הרשמי
    # (אינדקס-הפקודות, תנאי-שירות-35/חופשות-ונופש-04) וכל ההפניות עודכנו (2026-08-07).
    "350408": ("35.0408", "פעילויות גיבוש והפגה, סיורים, ימי כיף, טיולים ונופשים"),
    ...
    # הרחבה 2026-07-22: פערי-ביקוש מהפיילוטים — פניות-ציבור, חיוב וגביית
    # חובות (כולל חוסר בציוד), ופיצוי על ציוד פרטי שאבד או ניזוק בשירות.
    "80101":  ("8.0101", "פניות גורמים אזרחיים - חובת מתן תשובה והנמקה"),
    "350221": ("35.0221", "הפקעת משכורת, גביית קנסות, פיצויים וחובות"),
    "350223": ("35.0223", "אובדן או נזק ציוד אזרחי - חיילים בשירות סדיר או מילואים"),
    # רענון 61.0104 מטקסט-PDF מעורבל ל-HTML הנקי (פער ימי-הגימ"לים)
    "610104": ("61.0104", "טיפול רפואי בחייל"),
}

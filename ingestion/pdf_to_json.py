...
2. לכל קהל שסימנת, הצע 3–4 שאלות שאותו קהל באמת ישאל על הפקודה הזו. כללים מחייבים:
   - שאלות פשוטות, קצרות ומעשיות — מה שאדם אמיתי מקליד בצ'אט, לא ניסוח בירוקרטי.
   - לחיילים (soldier): שאלות בגוף ראשון על מה מגיע לי / מותר לי / אסור עליי ומה עושים בפועל. למשל "כמה ימי חופשה מגיעים לי?" ולא "מהם עקרונות מדיניות החופשות".
   - למפקדים (commander): שאלות על סמכויות — מה אני רשאי לאשר, אילו עונשים מותר להטיל, מה חובות הדיווח שלי, איזו דרגה נדרשת.
   - למילואים (reserve): שאלות על זכויות, תגמולים, דחיות שירות והחזרים הייחודיים למילואים.
